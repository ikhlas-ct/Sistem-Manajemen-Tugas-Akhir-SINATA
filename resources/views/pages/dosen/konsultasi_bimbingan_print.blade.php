...
<body>
    <div class="container">
        ...
        <div class="content" style="display: grid; grid-template-columns: 150px auto;">
            ...
            <p style="margin-bottom: 8px;">: {{ $mahasiswaBimbingan->mahasiswa->nama }}</p>
            
            <p style="margin-bottom: 8px;">NIM</p>
            <p style="margin-bottom: 8px;">: {{ $mahasiswaBimbingan->mahasiswa->nim }}</p>
            
            <p style="margin-bottom: 8px;">Jurusan</p>
            <p style="margin-bottom: 8px;">: {{ $mahasiswaBimbingan->mahasiswa->fakultas }}</p>
            ...
            <p style="margin-bottom: 8px;">: {{ $mahasiswaBimbingan->dosenPembimbing->dosen->nama }}</p>
        </div>
